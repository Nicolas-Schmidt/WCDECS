...
margins::cplot(m_factorial, ylim= c(0,1), x = "args", dx = "tr", data = johnston[!is.na(johnston$args), ], what = "effect")
...
# Plots of CATEs
margins::cplot(m, x = "XPARTY7", dx = "tr", what = "effect")
margins::cplot(m, x = "XPP10035", dx = "tr", what = "effect")
margins::cplot(m, x = "PPGENDER", dx = "tr", what = "effect")
margins::cplot(m, x = "PPEDUC", dx = "tr", what = "effect")
margins::cplot(m, x = "PPETHM", dx = "tr", what = "effect")
